...
Requirement:
  "As a new user, I want a simple login page so that I can quickly create an account and get to studying"
Issue: #77
- Pull request: #67
...
Requirement:
  "As a new user, I want to easily add classes to my calendar, so that I can find potential study partners."
Issue: #78
- Pull request: #70
