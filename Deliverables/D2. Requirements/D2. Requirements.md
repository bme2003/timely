...
1. As a busy student, I want to be able to have a variety of available meeting times so that I can have a flexible schedule.
2. As a new user, I want to be able to quickly create, accept, or decline study invitations so that I can collaborate with peers without any delays.
