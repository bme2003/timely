...
- **3a.** User inputs an invalid user.
  - The system asks for another user and informs the user that the profile was invalid.

- **5a.** Users reject the invite.
  - The system does not add those users to the group.
...
3. As a user, I want to recieve notifications for upcoming meetings and invitations so that I can stay updated on activities.(Priority: 9, Hours: 5)
4. As a user, I want Timely to work seamlessly on other devices to ensure I can access it from any of my devices easily.(Priority: 7, Hours: 12)
