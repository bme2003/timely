...
as a student it would be nice to import my schedule into a program so it can set my availability publicly.

#user story 1:

as a student it would be nice to know other students schedules so that I can plan study groups.
