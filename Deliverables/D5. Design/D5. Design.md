...
<br>
This diagram is another example of an SRP as these 2 classes are being used to schedule meeings, The meetings class actually creates the meeting, and the Meeting Invite class actually sends out invites to the users. 
